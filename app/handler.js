...
const putHandler = (request, h) => {
  ...
  if (index !== -1) {
    bookshelf[index] = { ...bookshelf[index], name, year, author, summary, publisher, pageCount, readPage, reading, updatedAt }
    const response = h.response({
      status: 'success',
...
module.exports = { postHandler, getAllHandler, getByIdHandler, putHandler, deleteHandler }